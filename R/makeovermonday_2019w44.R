...
p <- p1 + p2 +
  ...
  plot_annotation(
    ...
    subtitle = str_wrap("Left: Number of hours of sunshine per month for all the cities for which there is data. Right: Top ten cities with the most number of sunshine hours per continent.", 100),
